                        ...
                        <div class="div card-body">
                            <form method="POST" action="../../../dashboard/controller/proses_data_alat.php" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="nomer_kalibrasi">No Kalibrasi</label>
                                            <input type="text" name="no_kalibrasi" placeholder="Nomor Alat" value="<?php echo $nomer_alat;  ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_kalibrasi" placeholder="Nomor Alat" value="<?php echo $nomer_alat;  ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="status">Tanggal Berakhirnya Kalibrasi</label>
                                            <input type="date" name="thl_berakhirnya_masa_kalibrasi" placeholder="Spek, Merk, dan Type Alat" value="<?php echo $spek_merk_type;  ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
