<?php
include 'koneksi.php';
$hasil=mysqli_query($connect,"SELECT k.`no_kalibrasi`, b.`nama_barang`, k.`tanggal_kalibrasi`, k.`petugas_penerima`, 
    k.`petugas_menyerahkan`, k.`tgl_exp`, k.`pihak_kalibrasi`, k.`keterangan_kalibrasi`,
    k.`keterangan_notifikasi`, k.`foto`
FROM kalibrasi k
JOIN barang b ON b.`id_barang` = k.`id_barang`
WHERE k.`tgl_exp` >= DATE_ADD(NOW(),INTERVAL -90 DAY)")
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <header class="sidebar-header">
                ...
                <div class="sidebar-widget menu-widget">
                    <div class="row text-center mbn">
                        <div class="col-xs-4">
                            <a href="main.php" class="text-primary" data-toggle="tooltip" data-placement="top"
                               title="Dashboard">
        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Info Kalibrasi</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
            ...
            <div class="tray tray-center">
                ...
                <div class="admin-panels fade-onload">
                    ...
                    <div class="content-header">
                      <h2> <b>Admin Forms</b> Informasi Kalibrasi </h2>
                      <p class="lead">Data Alat yang memasuki jadwal Re-Kalibrasi</p>
                    </div>
                    <!-- Task Widget -->
                    <div class="col-md-12">
