            ...
            <header id="topbar" class="alt">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Kalibrasi</li>
                    </ol>
                </div>
            </header>
            <!-- End: Topbar -->
                ...
                <div class="tray tray-center">
                    ...
                    <div class="admin-panels fade-onload">
                        ...
                        <div class="content-header">
                            <h2> <b>Admin Forms</b> Input Data Kalibrasi </h2>
                            <p class="lead">Data Master untuk Input Data Seluruh Kalibrasi</p>
                        </div>
                        <!-- Begin: Admin Form -->
                                ...
                                <div class="panel-body bg-light">
                                    <form method="post" action="" id="form-ui">
                                        <div class="section-divider mb40" id="spy1">
                                            <span>Form Input Data Kalibrasi</span>
                                        </div>
                                        <!-- .section-divider -->
                                        <!-- Basic Inputs -->
                                        <table cellpadding="8">
                                            ...
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="text" name="nama" class="gui-input" placeholder="Nomer Kalibrasi">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="text" name="merk" class="gui-input" placeholder="Barang">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="date" name="tipe" class="gui-input" placeholder="Tanggal Kalibrasi">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="text" name="jumlah" class="gui-input" placeholder="Petugas Penerima">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="text" name="keterangan" class="gui-input" placeholder="Petugas Penyerah">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="date" name="harga" class="gui-input" placeholder="Tanggal Expired">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="date" name="harga" class="gui-input" placeholder="Pihak Kalibrasi">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="date" name="harga" class="gui-input" placeholder="Keterangan Kalibrasi">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="col-md-8">
                                                    <div class="section">
                                                        <label class="field">
                                                            <input type="date" name="harga" class="gui-input" placeholder="Foto">
                                                        </label>
                                                    </div>
                                                </div>
                                            </tr>
                                ...
                                <table class="table table-striped table-hover" id="datatable2">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_array($hasil)) {
                                            echo "<tr>";
                                            echo "<td>" . $data['no_kalibrasi'] . "</td>";
                                            echo "<td>" . $data['nama_barang'] . "</td>";
                                            echo "<td>" . $data['tanggal_kalibrasi'] . "</td>";
                                            echo "<td>" . $data['petugas_penerima'] . "</td>";
                                            echo "<td>" . $data['petugas_menyerahkan'] . "</td>";
                                            echo "<td>" . $data['tgl_exp'] . "</td>";
                                            echo "<td>" . $data['pihak_kalibrasi'] . "</td>";
                                            echo "<td>" . $data['keterangan_kalibrasi'] . "</td>";
                                            echo "<td>" . $data['keterangan_notifikasi'] . "</td>";
                                            echo "<td>" . $data['foto'] . "</td>";
                                            echo "<td><a href='edit.php?id=$data[no_kalibrasi]'>Edit</a> | <a href='hapus.php?id=$data[no_kalibrasi]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
