              ...
              <div class="panel-body bg-light p30">
                <div class="col-xs-6">
                  <a href="dashboard.html" title="Return to Dashboard">
                    <img src="assets/img/logos/Sucofindo_Utama (1).png" title="Admin Logo" class="img-responsive w250 mx-auto">
                  </a>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-5 br-l br-grey pl30">
                    ...
                    <p class="mb15">
                      <span class="fa fa-check text-success pr5"></span> Daftarkan Personal Anda ke Administrator
                    </p>
                    <p class="mb15">
                      <span class="fa fa-check text-success pr5"></span> Anda Mendapat Username dan Password dari Administrator Setelah Pengajuan Data
                    </p>
                    <p class="mb15">
                      <span class="fa fa-check text-success pr5"></span> Gunakan Aplikasi Dengan Bijak
                    </p>
                    <p class="mb15">
                      <span class="fa fa-check text-success pr5"></span> Verifikasi Data Masukkan Agar Mendapat Informasi yang Tepat Guna
                    </p>
                  </div>
                </div>
              </div>
